                                ...
                                <div class="card-body">
                                    <form action="{{route('pendingResponse')}}" method="GET">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="searchDivision">Gramasewa division</label>
                                                ...
                                                <select class="form-control select2" name="searchDivision"
                                                    ...
                                                    @if($gramasewaDivisions != null)
                                                        @foreach($gramasewaDivisions as $gramasewaDivision)
                                                            <option value="{{$gramasewaDivision->idgramasewa_division}}">{{$gramasewaDivision->name_en}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                                            ...
                                                            @if(count($responses) > 0)
                                                                @foreach($responses as $response)
                                                                    ...
                                                                    <tr id="{{$response->idpost_response}}">
                                                                            ...
                                                                            <td>{{strtoupper($response->user->username)}} </td>
                                                                            <td>{{sprintf('%06d',$response->post->post_no)}} </td>
                                                                            <td>{{strtoupper($response->user->getType->gramasewaDivision->name_en)}} </td>
