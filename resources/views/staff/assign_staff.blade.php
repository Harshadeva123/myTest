                                            ...
                                            @if(count($users) > 0)
                                                @foreach($users as $user)
                                                    <tr id="{{$user->idUser}}">
                                                        ...
                                                        <td>{{$user->officeStaff->officeGramasewa()->count()}} GRAMASEWA
                                                            DIVISIONS
                                                        </td>
...
@section('psScript')
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function closeModal() {
            ...
            $('#pollingBooths').val('').trigger('change');
            $('#gramasewaDivisions').val('').trigger('change');
            $('#staffId').val('');
                ...
                success: function (data) {
                    ...
                    if (data.success != null) {
                        ...
                        $.each(divisions, function (key, value) {
                            $('#viewTBody').append('' +
                                '<tr>' +
                                '<td>' + value.gramasewa.polling_booth.election_division.name_en + '</td>' +
                                '<td>' + value.gramasewa.polling_booth.name_en + '</td>' +
                                '<td>' + value.gramasewa.name_en + '</td>' +
                                '</tr>');
                        });
